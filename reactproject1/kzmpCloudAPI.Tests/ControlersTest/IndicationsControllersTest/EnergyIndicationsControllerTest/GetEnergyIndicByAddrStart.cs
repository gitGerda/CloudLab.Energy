...
{
    public class GetEnergyIndicByAddrStart : IClassFixture<KzmpEnergyTestingDbFixture>
    {
        public KzmpEnergyTestingDbFixture Fixture
        {
            get;
        }
        public GetEnergyIndicByAddrStart(KzmpEnergyTestingDbFixture fixture)
        {
            Fixture = fixture;
        }

        [Fact]
        public void GetEnergyIndicByAddrStart_GetRecords_NullAddresses()
        {
            //arrange
            ...
            //act
            var result = controller.GetEnergyIndicByAddrStart(KzmpEnergyTestingDbFixture.DEFAULT_START_DATE.ToString(), null, null, null, false);
        ...
        [Fact]
        public void GetEnergyIndicByAddrStart_GetCount_RecordsCountForAllAddresses()
        {
            //arrange
            var _logger = new Mock<ILogger<EnergyIndicationsController>>().Object;
            EnergyIndicationsController controller = new EnergyIndicationsController(Fixture.CreateContext(), _logger);
            ...
            //act
            var result = controller.GetEnergyIndicByAddrStart(KzmpEnergyTestingDbFixture.DEFAULT_START_DATE.ToString(), null, null,
        ...
        [Fact]
        public void GetEnergyIndicByAddrStart_GetRecords_Page1Count()
        {
            //arrange
            var _logger = new Mock<ILogger<EnergyIndicationsController>>().Object;
            EnergyIndicationsController controller = new EnergyIndicationsController(Fixture.CreateContext(), _logger);
            ...
            //act
            var result = ((JsonResult)controller.GetEnergyIndicByAddrStart(KzmpEnergyTestingDbFixture.DEFAULT_START_DATE.ToString(),
                1, KzmpEnergyTestingDbFixture.DEFAULT_ROWS_FOR_METER, KzmpEnergyTestingDbFixture.DEFAULT_ADDRESSES, false))
        ...
        [Fact]
        public void GetEnergyIndicByAddrStart_GetRecords_Page2Count()
        {
            //arrange
            var _logger = new Mock<ILogger<EnergyIndicationsController>>().Object;
            EnergyIndicationsController controller = new EnergyIndicationsController(Fixture.CreateContext(), _logger);
            ...
            //act
            var result = ((JsonResult)controller.GetEnergyIndicByAddrStart(KzmpEnergyTestingDbFixture.DEFAULT_START_DATE.ToString(),
                2, KzmpEnergyTestingDbFixture.DEFAULT_ROWS_FOR_METER, KzmpEnergyTestingDbFixture.DEFAULT_ADDRESSES, false))
                ?.Value as List<EnergyTable>;
        ...
        [Fact]
        public void GetEnergyIndicByAddrStart_GetRecords_Page1LastRecordAddress()
        {
            //arrange
            var _logger = new Mock<ILogger<EnergyIndicationsController>>().Object;
            EnergyIndicationsController controller = new EnergyIndicationsController(Fixture.CreateContext(), _logger);
        ...
        [Fact]
        public void GetEnergyIndicByAddrStart_GetRecords_Page2LastRecordAddress()
        {
            //arrange
            var _logger = new Mock<ILogger<EnergyIndicationsController>>().Object;
            EnergyIndicationsController controller = new EnergyIndicationsController(Fixture.CreateContext(), _logger);
        ...
        [Fact]
        public void GetEnergyIndicByAddrStart_GetRecords_Page2FirstRecordAddress()
        {
            //arrange
            var _logger = new Mock<ILogger<EnergyIndicationsController>>().Object;
            EnergyIndicationsController controller = new EnergyIndicationsController(Fixture.CreateContext(), _logger);
